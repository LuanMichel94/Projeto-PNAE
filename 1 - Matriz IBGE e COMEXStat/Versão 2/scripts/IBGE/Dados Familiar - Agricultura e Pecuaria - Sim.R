...
# Passo 1.3: Conferir nome das Sheets
# ----------------------------------------------------------------------------------------------------------------------
...
# Passo 1.4: Leitura das bases de dados - Agricultura
# ----------------------------------------------------------------------------------------------------------------------
...
# Passo 1.5: Leitura das bases de dados - Pecuaria - Quantidade Produzida
# ----------------------------------------------------------------------------------------------------------------------
...
# Passo 1.6: Leitura das bases de dados - Pecuaria - Valor da Produção
# ----------------------------------------------------------------------------------------------------------------------
...
# Passo 1.7: Conferindo se todas as bases possuem assinatura do IBGE ao final
# ----------------------------------------------------------------------------------------------------------------------
...
# Passo 2.3: Separando Município de Estado, limpeza na coluna Grupo e separando Produto de Unidade de Medida
# ----------------------------------------------------------------------------------------------------------------------
...
# Passo 3.3: Separando Município de Estado, limpeza na coluna Grupo e separando Produto de Unidade de Medida
# ----------------------------------------------------------------------------------------------------------------------
...
# Passo 4.1: Base Final
# ----------------------------------------------------------------------------------------------------------------------
data_fam_sim <- quantidade_produzida_fam_sim %>% bind_rows(valor_da_producao_fam_sim)


# Passo 4.2: Retirando todas as outras bases e deixando somente a base final
# ----------------------------------------------------------------------------------------------------------------------
rm(
